...
$.ajax({
    ...
    data: {
        key: '32TBZ-WKJ65-JXFI4-IFFRS-MJPF2-2KF5I',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(115.658426, 38.563411, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
